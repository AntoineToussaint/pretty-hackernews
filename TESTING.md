...
1. Download **`hatch-extension.zip`** and **unzip** it (you'll get a folder).
...
- Press **j / k** to move, **o** to open a story, **u** to upvote (logged in).
- **Comment** and **reply** on a story (uses your existing HN login — no
  passwords go to the extension).
- Bookmark a story (the 🔖), then open the **bookmark** in the header.
- Click **Preview** on a story → enable previews via the toolbar icon → read
  the linked article inline.
